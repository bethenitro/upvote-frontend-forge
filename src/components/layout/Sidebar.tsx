    ...
    <aside className="w-64 bg-white border-r border-gray-200 h-full flex flex-col">
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-xl">UpvoteHub</h1>
        </div>
      </div>
      ...
      <div className="p-4 flex flex-col items-center border-b border-gray-200">
        {user && (
          <>
            ...
            <div className="bg-upvote-gray-100 w-full rounded-md p-2 text-center">
              <p className="text-xs text-upvote-neutral">Balance</p>
              <p className="font-bold text-lg">{user.credits.toFixed(2)} credits</p>
            </div>
          </>
        )}
      </div>
